...
BOOST_AUTO_TEST_CASE( test_mismatch )
{
    ...
    cs2 = "TeSt_liNk";
    BOOST_TEST(
        TEST_SURROUND_EXPRESSION(utu::mismatch( cs1.begin(), cs1.end(), cs2.begin(), cs2.end(), std::cref( predicate ) ).first - cs1.begin()) == 5 );
}
...
BOOST_AUTO_TEST_CASE( test_find_first_not_of )
{
    ...
    another = "T_sE";
    BOOST_TEST(
        TEST_SURROUND_EXPRESSION(utu::find_first_not_of( cs.begin(), cs.end(), another.begin(), another.end(), std::cref( predicate ) ) - cs.begin()) == 7 );
...
BOOST_AUTO_TEST_CASE( test_find_last_of )
{
    ...
    another = "_Se";
    BOOST_TEST( TEST_SURROUND_EXPRESSION(utu::find_last_of( cs.begin(), cs.end(), another.begin(), another.end(), std::cref( predicate ) ) - cs.begin()) == 5 );
...
BOOST_AUTO_TEST_CASE( test_find_last_not_of )
{
    ...
    another = "_SeG";
    BOOST_TEST( TEST_SURROUND_EXPRESSION(utu::find_last_not_of( cs.begin(), cs.end(), another.begin(), another.end(), std::cref( predicate ) ) - cs.begin()) == 9 );
